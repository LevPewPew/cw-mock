...
/* yet another solution...
  ...
  make shared components a private npm package that is published, and a dependency in each app.
  the added benefit of this is a stream is not even forced to update their component if they don't want to yet

  can we do a private npm package? i don't think people will like this idea
  because they will want to keep the shared components within repo... but still should run it by
*/
